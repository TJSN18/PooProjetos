...
public static void sistema() throws NumberFormatException, IllegalStateException, InputMismatchException, IndexOutOfBoundsException{
    ...
    int opcao;
    String nome, profissao, id, descricao, data_inicio, data_final, coord, procura, status, identify, disciplina, funcionalidade;
    ...
    while(true){
        ...
        if(opcao == 0){
            ...
            if(opcao == 0){
                ...
                if(profissao.equals("Coordenador") || profissao.equals("coordenador")){
                    System.out.println("Digite o numero de identificaçao: ");
                    identify = escan.nextLine();
                    usuario.add(new Coordenador(nome, senha, recuperar, profissao, identify));
                }
                if(profissao.equals("Professor") || profissao.equals("professor")){
                    System.out.println("Digite o numero de identificaçao: ");
                    identify = escan.nextLine();
                    System.out.println("Digite a Disclipa lecionada: ");
                    disciplina = escan.nextLine();
                    usuario.add(new Professores(nome, senha, recuperar, profissao, identify, disciplina));
                }
                if(profissao.equals("Tecnico") || profissao.equals("tecnico") || profissao.equals("técnico") || profissao.equals("Técnico")){
                    System.out.println("Digite o numero de identificaçao: ");
                    identify = escan.nextLine();
                    System.out.println("Digite sua funcinalidade tecnica: ");
                    funcionalidade = escan.nextLine();
                    usuario.add(new Tecnico(nome, senha, recuperar, profissao, identify, funcionalidade));
                }
                else{
            ...
            if(opcao == 0){
                ...
                if(opcao == 0){
                    ...
                    editAtividade.tasks_reali.add(new Task(tarefa));
